...
learning_objectives:
  ...
  - "Agent SDK의 세션 API(listSessions, forkSession 등)를 활용할 수 있다"
...
```typescript
import { listSessions, getSessionMessages, forkSession, renameSession, tagSession } from '@anthropic-ai/claude-agent-sdk';
